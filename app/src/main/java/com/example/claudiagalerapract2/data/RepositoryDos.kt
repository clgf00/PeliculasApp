...
object RepositoryDos {
    ...
    init {
        ...
        peliculas.add(Pelicula(4,"La Ciudad Perdida", 2010, "Ana Martinez", "fantasia", false, 2.0))
        peliculas.add(Pelicula(5,"Operación Relámpago", 2021, "Luis Hernandez", "accion", true, 5.0))
    }
